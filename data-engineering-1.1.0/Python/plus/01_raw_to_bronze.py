...
_parse_datatype_string("value STRING")
...
# TODO
from pyspark.sql.types import _parse_datatype_string
assert raw_health_tracker_data_df.schema == _parse_datatype_string(kafka_schema), "Schemas do not match"
...
# MAGIC %sql
# MAGIC 
# MAGIC DESCRIBE DETAIL health_tracker_plus_bronze
...
display(bronzeTable.history()) #this is displaying the transaction log json file ( %/dataengineering/plus/bronze/_delta_log/*.json)
